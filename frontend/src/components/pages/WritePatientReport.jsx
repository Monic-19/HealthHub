        ...
        <div className=' bg-[#CFD8DB] h-[100vh] w-full flex justify-center items-center'>
            <div className='profile bg-white h-[85vh] w-[90vw] rounded-xl shadow-2xl p-6 overflow-scroll'>
                ...
                <div onClick={() => document.getElementById('profileImageInput').click()}>
                    {image ? (
                        <img src={image} alt="Profile Preview" style={{ border: '2px dashed #ccc', borderRadius: '10px', padding: '20px', width: '20vw', margin: '20px auto', cursor: 'pointer', textAlign: "center" }} />
                    ) : (
                        <Button variant="gradient" className="flex items-center gap-3 ml-auto mr-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="h-5 w-5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z" /></svg>
                            Upload Files
                        </Button>
                    )}
                </div>
